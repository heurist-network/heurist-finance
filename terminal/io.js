...
import { BRAND, BOLD, DIM, RESET, BRIDGE_URL, REPORTS_DIR, tui } from './state.js';
...
/**
 * Health check on startup — probe bridge + MCP, update splash status.
...
export async function healthCheck() {
  ...
  if (bridgeUp) {
    emitter.emit('_splash', { msg: 'Waiting for agent · MCP ready · 25 tools' });
  } else {
